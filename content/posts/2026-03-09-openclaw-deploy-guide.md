...
**相关阅读：**
- [OpenClaw + 企业微信：让 AI 每天自动推送日报](/posts/2026-03-09-openclaw-wecom-daily/)
...
OpenClaw 需要一台长期在线的服务器。我用的是[阿里云 ECS](https://www.aliyun.com/daily-act/ecs/activity_selection?userCode=132pbq5s)，2核2G的配置跑 OpenClaw 完全够用，新用户有专属优惠价。如果你也想部署一套自己的 AI 管家，从这里开始。
